...
class TuyenStatsRequest(BaseModel):
    """Payload đoạn cáp truyền vào API tính toán thống kê tuyến."""
    id: str = Field(..., alias="_id")
    parent_id: str  # _id của tuyến cha
    code: Optional[str] = None
    ma_tuyen: Optional[str] = None
    total_cable: Optional[float] = 0
    error_cable: Optional[int] = 0
    available_cable: Optional[int] = 0
    used_cable: Optional[int] = 0
    start_point: Optional[str] = None
    end_point: Optional[str] = None
    length_cable: Optional[float] = 0
    ghi_chu: Optional[str] = None
    start_point_text: Optional[str] = None
    end_point_text: Optional[str] = None
    so_luong_sid: Optional[int] = 0
    total_sid_raw: Optional[int] = 0
